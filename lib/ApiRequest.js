...
class ApiRequest {
    static checkOptions({options, requestOptions}) {
        if (!requestOptions.requireToken) requestOptions.requireToken = true;
    ...
    static get(path, options, params = {}, requestOptions = {}) {
        options = ApiRequest.checkOptions({options, requestOptions});
